...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-csv", type=Path, default=OUTPUT_DIR / f"agency_directory_accounts_{TODAY}.csv")
    parser.add_argument("--output-seed-file", type=Path, default=OUTPUT_DIR / f"agency_directory_seed_urls_{TODAY}.txt")
